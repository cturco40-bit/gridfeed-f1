import { fetchWT, sb, logSync, json, getLatestSession, matchRaceId, SESSION_TYPE_MAP, isCancelledCircuit } from './lib/shared.js';
...
export default async (req, context) => {
  ...
  try {
    ...
    const res = await fetchWT(`https://api.openf1.org/v1/intervals?session_key=${session.session_key}`);
